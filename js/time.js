function showTime() { 
	...
	var startDate = new Date('2020/05/15 23:42:00');
	var date3 = currentDate.getTime()-startDate.getTime(); //差值秒数
	// var days = parseInt(date3/86400);
	// var hours = parseInt(date3/3600)-24*days;
	// var minutes = parseInt(date3%3600/60);
	// var seconds = parseInt(date3%60);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear NingShuting:<br>"
		...
		+	"<c style=\"color: rgb(255, 255, 255); text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----WangEnqi   2020-05-15</c>"; 
